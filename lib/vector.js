...
export function SVG_object(matrix, margin) {
    let stream = [];
...
export function svg(matrix, stream, margin, size, foreColor, backColor, transparent) {
    let X = matrix.length + 2 * margin;
...
export function eps(matrix, stream, margin, size, foreColor, backColor, transparent) {
    let N = matrix.length;
    let scale = 9;
    let X = (N + 2 * margin) * scale;
...
export function pdf(matrix, stream, margin, size, foreColor, backColor, transparent) {
    // TODO deflate
    let N = matrix.length;
    let scale = 9;
    let X = (N + 2 * margin) * scale;
